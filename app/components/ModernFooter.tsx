...
export default function ModernFooter() {
  ...
  return (
    <footer className="bg-gradient-to-br from-secondary to-gray-800 text-white">
          ...
          <div>
            <Link href="/" className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-primary-light">Engineering Excellence</p>
              </div>
            </Link>
            ...
            {contact && (
              <div className="space-y-3 text-sm">
                <div className="flex items-center space-x-2">
                  <Phone className="text-primary-light flex-shrink-0" size={16} />
                  <div>
                ...
                <div className="flex items-center space-x-2">
                  <Mail className="text-primary-light flex-shrink-0" size={16} />
                  <a
                ...
                <div className="flex items-start space-x-2">
                  <MapPin className="text-primary-light mt-1 flex-shrink-0" size={16} />
