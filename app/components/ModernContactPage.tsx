        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              {/* Why Choose Us */}
              <div className="bg-gradient-to-r from-primary to-primary-dark text-secondary p-6 rounded-lg">
                <h3 className="text-lg font-semibold mb-4">Why Choose Us?</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    <Award className="h-8 w-8 mx-auto mb-2 text-secondary/80" />
                    <div className="text-lg font-bold">25+</div>
                    <div className="text-secondary/70 text-xs">Years Experience</div>
                  </div>
                  <div className="text-center">
                    <Shield className="h-8 w-8 mx-auto mb-2 text-secondary/80" />
                    <div className="text-lg font-bold">ISO</div>
                    <div className="text-secondary/70 text-xs">Certified</div>
                  </div>
                  <div className="text-center">
                    <Users className="h-8 w-8 mx-auto mb-2 text-secondary/80" />
                    <div className="text-lg font-bold">500+</div>
                    <div className="text-secondary/70 text-xs">Happy Clients</div>
                  </div>
                  <div className="text-center">
                    <Star className="h-8 w-8 mx-auto mb-2 text-secondary/80" />
                    <div className="text-lg font-bold">4.9</div>
                    <div className="text-secondary/70 text-xs">Rating</div>
                  </div>
                </div>
              </div>
            </motion.div>
