...
export default function ModernHeader() {
  ...
  return (
    <>
      {/* Top Bar */}
      <div className="bg-primary text-secondary py-3 hidden lg:block">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:block">
              <Link
                href="/contact"
                className="bg-gradient-to-r from-primary to-primary-dark text-secondary px-6 py-3 rounded-full font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105"
              >
                Get Quote
              </Link>
            </div>
            ...
            >
              <div className="max-w-7xl mx-auto px-6 py-4 space-y-4">
                ...
                <Link
                  href="/contact"
                  onClick={() => setIsMenuOpen(false)}
                  className="block w-full text-center bg-primary text-secondary py-3 rounded-lg font-semibold mt-4"
                >
                  Get Quote
                </Link>
              </div>
